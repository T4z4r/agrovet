                ...
                <form method="POST" action="{{ route('web.superadmin.common-products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="default_cost_price" name="default_cost_price" value="{{ old('default_cost_price') }}" placeholder="0.00" required min="0" step="0.01">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="default_selling_price" name="default_selling_price" value="{{ old('default_selling_price') }}" placeholder="0.00" required min="0" step="0.01">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="default_minimum_quantity" name="default_minimum_quantity" value="{{ old('default_minimum_quantity') }}" placeholder="0" min="0">
