        ...
        <div class="modal-content">
            ...
            <form id="createForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="create_features" class="form-label">Features</label>
                        <textarea class="form-control" id="create_features" name="features"></textarea>
                    </div>
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#edit_features').val(data.features ? JSON.stringify(data.features) : '');
