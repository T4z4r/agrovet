                ...
                <form method="POST" action="{{ route('web.privacy-policies.update', $privacyPolicy) }}">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $privacyPolicy->title) }}" placeholder="Enter policy title" required>
                            @error('title')
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="content" name="content" rows="10" placeholder="Enter policy content" required>{{ old('content', $privacyPolicy->content) }}</textarea>
                            @error('content')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
