                ...
                <form method="POST" action="{{ route('staff.update', $user) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $user->name) }}" placeholder="Enter staff name" required>
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="branch_id" class="form-label">Branch <span class="text-muted">(optional)</span></label>
